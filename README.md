...
- **물리**: 중력·점프·건물 AABB 충돌·탄도 낙차(총알이 중력으로 떨어짐)·반동
- **맵**: 마을 5곳·군 기지(담장+감시탑)·컨테이너·바위·나무 등 다수 구조물
- **무기**: 실제 GLB 6종, 1인칭 뷰모델(총열 자동 정렬) + 3인칭 부착
- **생존**: 7단계 수축 자기장 + 자기장 데미지 + 60개 전리품 (AI 적 없음)
